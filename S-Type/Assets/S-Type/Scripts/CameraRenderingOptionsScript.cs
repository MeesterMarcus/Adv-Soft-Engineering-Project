...
public class CameraRenderingOptionsScript:MonoBehaviour
{
	...
	public void Start()
	{
		if (setCameraAspect == true) GetComponent<Camera>().aspect = 1.6f; // camera aspect is 16/10
	...
	public void SetOrthoSize()
	{
		...
		gameObject.GetComponent<Camera>().orthographicSize = (Screen.height/100.0f/2.0f);// 100f is the PixelPerUnit that you have set on your sprite. Default is 100.
